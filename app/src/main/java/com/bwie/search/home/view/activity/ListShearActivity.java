...
public class ListShearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_shear);
        initView();
        initData();
    }
    //初始化控件
    private void initView() {
        ...
        share = (ImageView) findViewById(R.id.share2);
    ...
    private void initData() {
        ...
        sss = intent.getStringExtra("aaa");
        //和百度网址进行拼接
        webview.loadUrl("https://www.baidu.com/s?wd=" + sss);
